...
$(function() {
    ...
    $grid.after('<div class="text-center"><a id="load-more" class="btn btn-success btn-md btn-arrow m-t-20" href="javascript:void(0)"> <span>Load More <i class="fa fa-refresh" aria-hidden="true"></i></span></a></div>');
